...
st.markdown("O Portal de Suprimentos é uma plataforma online que facilita a o gerenciamento das compras e de seus processos sob responsabilidade do Suprimentos. Aqui você pode:")
st.write(
