...
suppliers = ["Atlas Papelaria", "Atakadinho Bahia", "Autopel", "Brilhante", "Casa Norte", "Distribuidora Teresina", "JB Depósito de Construção", "J D R Sousa", "L C Vaz", "Macropack", "Miranda", "Mix Comércio", "Nacional", "Norte Saúde Hospitalar", "Shopping Hospitalar", "Supermercado São Jorge (JB)","Nagem","Dias Comércio","HR Papeis"]
