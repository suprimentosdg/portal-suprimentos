...
suppliers = ["Atlas Papelaria", "Atakadinho Bahia", "Autopel", "Brilhante", "Casa Norte", "Distribuidora Teresina", "JB Depósito de Construção", "J D R Sousa", "Macropack", "Mix Comércio", "Nacional", "Norte Saúde Hospitalar", "Supermercado São Jorge (JB)","Nagem","Dias Comércio","HR Papeis","Perola","Limpac","Baratão das Embalagens","Ecoville"]
