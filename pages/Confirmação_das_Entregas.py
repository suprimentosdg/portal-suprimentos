...
suppliers = ["Atlas Papelaria", "Atakadinho Bahia", "Autopel", "Brilhante", "Casa Norte", "Distribuidora Teresina", "J D R Sousa", "L C Vaz", "Macropack", "Mix Comércio", "Nacional", "Norte Saúde Hospitalar", "Shopping Hospitalar", "Supermercado São Jorge (JB)"]
