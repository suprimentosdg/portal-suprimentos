...
suppliers = ["Atlas Papelaria", "Atakadinho Bahia", "Autopel", "Brilhante", "Casa Norte", "Distribuidora Teresina", "Ecopaper", "Macropack", "Nacional", "Shopping Hospitalar", "Supermercado São Jorge (JB)"]
